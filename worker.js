export default {
  ...
  async fetch(request, env) {
    ...
    // Ini mengizinkan frontend (index.html) yang berada di domain Pages yang sama untuk berkomunikasi.
    ...
    const url = 
      ...
      env.GEMINI_KEY; // Kunci diambil dari Cloudflare Environment Variable
    ...
    return new Response(resultText, {
      ...
      headers: {
        "Access-Control-Allow-Origin": "*", // Memungkinkan akses dari frontend
        "Content-Type": "application/json"
      }
    });
  }
